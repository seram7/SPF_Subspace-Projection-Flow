...
class Flow_Sphere_Dsm_Trainer(BaseTrainer):
    def train(self, model, opt, d_dataloaders, logger=None, logdir='', scheduler = None, clip_grad=None):
        ...
        for i_epoch in trange(cfg.n_epoch, ncols=100):
            ...
            for x, y in indist_train_loader:
                ...
                if i % cfg.val_interval == 0:
                    ...
                    if cfg.best_save_interval is not None and i % cfg.best_save_interval == 0 and best_model:
                        ...
                        print(f'Iter [{i:d}] best model saved with val_auc {val_auc} >= {best_auc}')
        ...
        if cfg.get('compute_auc', False):
            ...
            d_result = 'Train results are not calculated'
        print(d_result)
