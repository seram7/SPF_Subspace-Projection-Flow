...
class VirtualTrainer(BaseTrainer):
    def train(self, model, opt, d_dataloaders, logger=None, logdir='', scheduler=None, clip_grad=None):
        ...
        for i_epoch in range(cfg.n_epoch):
            ...
            for x, y in indist_train_loader:
                ...
                d_train = model.train_step(x, y, opt, cfg.sample_number,cfg.sample_from,cfg.select,i_epoch,
                                           cfg.start_epoch,cfg.ur_loss_weight,self.device)
