...
class Backbone_sphere_Trainer(BaseTrainer):
    def train(self, model, opt, d_dataloaders, logger=None, logdir='', scheduler = None, clip_grad=None):
        ...
        criterion_disp = DispLoss(cfg.n_class,cfg.feature_dim, cfg.proto_m, model, indist_train_loader, cfg.disp_l_temp,
                                  cfg.disp_base_temp,self.device)
        ...
        for i_epoch in trange(cfg.n_epoch, ncols=100):
            ...
            for x, y in indist_train_loader:
                ...
                d_train = model.train_step(x, y, opt, criterion_disp, criterion_comp)
                ...
                if i % cfg.val_interval == 0:
                    ...
                    for val_x, val_y in indist_val_loader:
                        ...
                        d_val = model.validation_step(val_x, val_y,criterion_disp, criterion_comp)
